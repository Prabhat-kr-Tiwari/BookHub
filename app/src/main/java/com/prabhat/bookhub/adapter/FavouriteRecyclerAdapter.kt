package com.prabhat.bookhub.adapter
...
class FavouriteRecyclerAdapter(val context:Context,val bookList: List<BookEntity>):RecyclerView.Adapter<FavouriteRecyclerAdapter.FavouriteViewHolder>() {
    ...
    class FavouriteViewHolder(view: View):RecyclerView.ViewHolder(view){
        ...
        val txtBookRating:TextView=view.findViewById(R.id.imgFavBookImage)
        val txtBookPrice:TextView=view.findViewById(R.id.txtBookPrice)


        val imgBookImage: ImageView =view.findViewById(R.id.txtFavBookTitle)
